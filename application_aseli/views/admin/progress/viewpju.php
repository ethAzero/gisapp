...
<div class="content-wrapper">
   <section class="content-header">
      <h1>Progress PJU <small><?php echo $ruas->nm_ruas.' ( '.angka($ruas->jln_panjang).' m)' ?></small></h1>
      <ol class="breadcrumb">
   ...
   <section class="content">
      <a href="<?php echo base_url('admin/progress/pju/'.$balai->kd_balai) ?>"><button class="btn btn-primary btn-flat"><i class="fa fa-reply"></i> Kembali</button></a>
      <br><br>
      ...
      <?php foreach ($view as $key => $pju): ?>
         {
            ...
            imagezoom: '<?php if($pju->img_pju != null){echo base_url('assets/upload/pju/'.$pju->img_pju);}else{echo base_url('assets/theme/img/map-marker-logo.jpg');} ?>'
         },
      <?php endforeach ?>
   ];
