<div class="content-wrapper">
	<section class="content-header">
	   <h1>Progress RPPJ <?php echo $balai->nm_balai ?></h1>
	   <ol class="breadcrumb">
	...
	<section class="content">
		...
		<a href="<?php echo base_url('admin/progress/excelrppj/'.$balai->kd_balai) ?>" target="_blank"><button class="btn btn-success btn-flat" data-toggle="tooltip" data-placement="top" title="Export Excel"><i class="fa fa-file-excel-o"></i> Excel</button></a>
		<br><br>
	    	...
	    	<div class="box-body">
	         ...
	         <table class="table table-striped table-bordered table-hover" id="dataTables-example">
               ...
               <tr class="odd gradeX">
                  ...
                  <?php $jml = $this->dashboard_model->rekaprppj($ruas->kd_jalan); ?>
                  <?php foreach ($jml as $key => $jml): ?>
               	...
               	<td><a href="<?php echo base_url('admin/progress/rppj/view/'.$ruas->kd_balai.'/'.$ruas->kd_jalan) ?>"><button class="btn btn-xs btn-flat btn-primary" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></button></a></td>
                  <?php endforeach ?>
               </tr>        
               <?php $i++; } ?>	
	          	</tbody>
