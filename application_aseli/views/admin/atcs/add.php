...
<div class="row">
   <div class="col-md-12">
      ...
      if(isset($error)){
		...
		echo form_open(base_url('admin/atcs/addatcs/'.$detail->kd_kabkota), array('onsubmit' => 'return ValidasiKoordinat()'));
		?>
      <div class="row">
         <div class="col-md-9">
            <div class="box">
               <div class="box-body">
                  <div class="row">
                     ...
                     <div class="form-group col-md-12">
                        ...
                        <textarea name="source" class="form-control noresize"></textarea>
                     </div> 
                  </div>
               </div>
            </div>
         ...
         <div class="col-md-3">
            <div class="box box-primary">
               <div class="modal-footer">
                  <a href="<?php echo base_url('admin/atcs/cctv/'.$detail->kd_kabkota) ?>"><button type="button" class="btn btn-default btn-flat"><i class="fa fa-reply"></i> Batal</button></a>
