         ...
         <table class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tbody>
               ...
               <tr class="odd gradeX">
                  ...
                  <td width="12%"><?php if($pengguna->akseslevel == 'A'){echo "Admin";}else{echo "User";} ?></td>
                  <td width="8%"><?php if($pengguna->status == 'A'){ echo "<span class='label label-primary' data-toggle='tooltip' data-placement='top' title='aktif'>Aktif</span>";}else{echo "<span class='label label-danger' data-toggle='tooltip' data-placement='top' title='blokir'>Non Aktif</span>";} ?></td>
