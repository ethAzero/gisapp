...
<div class="row">
   <div class="col-md-12">
      ...
      echo form_open_multipart(base_url('admin/tagline'));
      ?>
      <div class="row">
         <div class="col-md-9">
               ...
               <div class="tab-content">
                     ...
                     <div class="box-body">
                        <div class="row">
                           <div class="form-group col-md-7">
                              <input type="file" name="gambar" accept=".JPG,.PNG" class="filestyle" data-buttonText="Upload Image" data-buttonBefore="true" data-iconName="fa fa-upload">
                              <small><p class="help-block">Max. 200 Kb (216x78 pixel)</p></small>
                           </div>
                  ...
                  <div class="tab-pane" id="tab3">
                     <div class="box-body">
                        <div class="row">
                           <div class="form-group col-md-12">
                              <input name="detail" class="tagsinput" type="text" value="<?php echo $tagline->home_tag ?>" data-role="tagsinput" placeholder="add detail" />
                           </div>
                        </div>
                     </div>
                  </div>
