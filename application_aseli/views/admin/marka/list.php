            ...
            <tbody>
               ...
               <tr class="odd gradeX">
                  ...
                  <td style="text-align:center;width:100px">
                     ...
                     <a href="<?php echo base_url('admin/marka/cetak/'.$list->kd_jalan) ?>" target="_blank"><button class="btn btn-xs btn-flat btn-primary" data-toggle="tooltip" data-placement="top" title="Cetak"><i class="fa fa-print"></i></button></a>
                  </td>
               </tr>        
               <?php $i++; } ?>
           </tbody>
