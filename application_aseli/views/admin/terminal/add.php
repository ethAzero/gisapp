...
<div class="row">
   <div class="col-md-12">
      ...
      if(isset($error)){
		...
		echo form_open_multipart(base_url('admin/terminal/add'), array('onsubmit' => 'return ValidasiKoordinat()'));
		?>
      <div class="row">
         <div class="col-md-9">
            <div class="box">
               <div class="box-body">
                  <div class="row">
                     <div class="form-group col-md-6">
                        ...
                        <input type="text" name="nmterminal" class="form-control" placeholder="Nama Terminal">
                     </div>
                     <div class="form-group col-md-6">
