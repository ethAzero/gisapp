   ...
   ?>
	<div class="box box-primary">
    	<div class="box-body">
            ...
            <div class="row">
                  <div class="col-sm-4"><a href="<?php echo base_url('admin/rambu/add') ?>"><button class="btn btn-success btn-flat"><i class="fa fa-plus"></i> Add</button></a></div>
                  <div class="col-sm-4">
         ...
         <table class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tbody>
               ...
               <tr class="odd gradeX">
                  ...
                  <td align="center"><?php echo $list->kd_rambu ?></td>
                  <td><?php echo $list->nm_ruas ?></td>
                  <td><!-- <?php echo $list->nm_perjal ?> --></td>
                  <td><?php echo $list->thn_pengadaan ?></td>
                  <td><?php echo $list->status ?></td>
                  <td style="text-align:center;width:100px">
                     <a href="<?php echo base_url('admin/rambu/edit/'.$list->kd_rambu) ?>"><button class="btn btn-xs btn-flat btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></button></a>
