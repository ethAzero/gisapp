...
<div class="content-wrapper">
   <section class="content-header">
      <h1>Apill <small><?php echo $ruas->nm_ruas.' ( '.angka($ruas->jln_panjang).' m)' ?></small></h1>
      <ol class="breadcrumb">
         <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
         <li class="active">View Apill</li>
      </ol>
   </section>
...
function myMap() {
   ...
   var ctaLayer = new google.maps.KmlLayer({
      url: '<?php echo base_url();?>'+'admin/apil/jalanprovinsi/'+<?php echo $ruas->kd_jalan ?>+'?dummy='+(new Date()).getTime(),
      map: map
   });
      ...
      <?php foreach ($view as $key => $view): ?>
         {
            ...
            image: '<?php if($view->img_apil != null){echo base_url('assets/upload/apil/thumbs/'.$view->img_apil);}else{echo base_url('assets/theme/img/map-marker-logo.jpg');} ?>'
         },
      <?php endforeach ?>
   ];
