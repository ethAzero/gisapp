...
function myMap() {
      ...
      <?php foreach ($list as $key => $list): ?>
         {
            ...
            type: 'stasiun',
            stasiun: '<?php echo $list->nm_stasiun ?>',
            balai: '<?php echo $list->nm_kabkota ?>',
            image: '<?php if($list->img_stasiun != null){echo base_url('assets/upload/stasiun/thumbs/'.$list->img_stasiun);}else{echo base_url('assets/theme/img/map-marker-logo.jpg');} ?>'
         },
      <?php endforeach ?>
   ];
   ...
   features.forEach(function(feature) {
      ...
      var contentString = '' +
                     ...
                     '<h5 class="title">'+ feature.stasiun +'</h5>' +
                     '<div class="describe">' +
                        '<div class="grup-info">' +
