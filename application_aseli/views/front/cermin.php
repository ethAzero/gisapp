      ...
      <div class="legenda">
         <div class="panel-info-legenda">
            ...
            <?php foreach ($count as $key => $count): ?>
               <tr>
                  <td><img src="<?php echo base_url('assets/theme/img/cermin_terpasang.png') ?>"><?php echo $count->terpasang ?> Terpasang</td>
               </tr>
               <tr>
                  <td><img src="<?php echo base_url('assets/theme/img/cermin_kebutuhan.png') ?>"><?php echo $count->kebutuhan ?> Kebutuhan</td>
               </tr>
               <tr>
                  <td><img src="<?php echo base_url('assets/theme/img/cermin_rusak.png') ?>"><?php echo $count->rusak ?> Rusak</td>
               </tr>
            <?php endforeach ?>
            </table>
         </div>
...
function myMap() {
   ...
   var features = [ 
      <?php foreach ($cermin as $key => $cermin): ?>
         {
