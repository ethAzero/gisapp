...
class Progress extends CI_Controller {
	...
	public function index($id) {
		...
		$percentdrk = $this->dashboard_model->percentdrk($id);
		
		$realdrk = $this->dashboard_model->realdrk($id);
		// print_r($realdrk);exit();
	...
	public function daerahrawan($id) {
		$balai = $this->dashboard_model->detailbalai($id);
		$ruas = $this->dashboard_model->progressdrk($id);
		// print_r($ruas);exit();
		$data = array('title' 		=> 'Progress Daerah Rawan Kecelakaan '.$balai->nm_balai,
							'balai'		=> $balai,
							'ruas'		=> $ruas,
							'isi' 		=> 'admin/progress/daerahrawan');
		$this->load->view('admin/layout/wrapper',$data);
	}

	public function exceldaerahrawan($id){
		$balai = $this->dashboard_model->detailbalai($id);
		$ruas = $this->dashboard_model->progressdrk($id);
		$data = array('balai'	=> $balai,
							'ruas' 	=> $ruas);
		$this->load->view('admin/progress/exceldaerahrawan', $data);
	}
}
