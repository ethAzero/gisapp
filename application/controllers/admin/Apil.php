...
class Apil extends CI_Controller{
	...
	public function detail($balai,$jln){
		...
		$data = array('title' 		=> 'Apill - '.$jalan->nm_ruas,
							'list'		=> $list,
							'jalan'		=> $jalan,
							'listjalan'	=> $listjalan,
