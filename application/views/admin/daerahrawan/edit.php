                     ...
                     <div class="box-body">
                        <div class="row">
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <select name="kabkota" class="form-control select2">
                                 <option value="">=== Kabupaten / Kota ===</option>
                                 <?php foreach ($kabkota as $key => $t) : ?>
                                    <option value="<?php echo $t->kd_kabkota ?>" <?php if ($t->kd_kabkota === $daerahrawan->kd_kabkota) {
                                                                                    echo "selected";
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <select name="statusjalan" class="form-control select2">
                                 ...
                                 <option value="1" <?php if ($daerahrawan->status_jalan == 1) {
                                                      echo "selected";
                                                   } ?>>Ruas Jl. Kab/Kota</option>
                                 <option value="2" <?php if ($daerahrawan->status_jalan == 2) {
                                                      echo "selected";
                                                   } ?>>Ruas Jl. Provinsi</option>
                                 <option value="3" <?php if ($daerahrawan->status_jalan == 3) {
                                                      echo "selected";
                                                   } ?>>Ruas Jl. Nasional</option>
                              </select>
                           </div>
                           <div class="form-group col-md-6">
