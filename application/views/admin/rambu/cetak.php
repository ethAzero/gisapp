 ...
 /* transform: 
  ...
  <body>
    <table class="table table-bordered">
          ...
          $image = ($row->img_rambu) ? '<img src="assets/upload/rambu/'.$row->img_rambu.'" width="80" >': '' ;
          //$jenis = ($row->img_rambu) ? '<img src="assets/upload/img_rambu/'.$row->img_tipe.'" width="50" >': '' ;
          $jenis = ($row->jenis) ? '<img src="assets/upload/img_rambu/'.$row->img_tipe.'" width="50" >': '' ;

          if($row->lat){
          ?>  
            <tr>
               <td><?php echo $no;?></td>
               <td><?php echo $row->kd_rambu;?></td>
