...
<div class="row">
   <div class="col-md-12">
      ...
      if(isset($error)){
		...
		echo form_open_multipart(base_url('admin/rambu/edit/'.$rambu->kd_rambu), array('onsubmit' => 'return ValidasiKoordinat()'));
		?>
      <div class="row">
         <div class="col-md-9">
            <div class="box">
               <div class="box-body">
                  <div class="row">
                     ...
                     <div class="form-group col-md-5">
                        ...
                        <select name="ruas" class="form-control select2" required>
                           <option value="">=== Nama Ruas Jalan ===</option>
                           <?php foreach ($jalan as $key => $jalan): ?>
                              <option value="<?php echo $jalan->kd_jalan ?>" <?php if($jalan->kd_jalan === $rambu->kd_jalan) {echo "selected";} ?> ><?php echo $jalan->nm_ruas ?></option>
                           <?php endforeach ?>
                        </select>
                     </div>
         ...
         <div class="col-md-3">
            <div class="box box-primary">
               <div class="modal-footer">
                  <a href="<?php echo base_url('admin/rambu') ?>"><button type="button" class="btn btn-default btn-flat"><i class="fa fa-reply"></i> Batal</button></a>
