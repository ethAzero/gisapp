...
?>
<a href="#" data-toggle="modal" data-target="#tukar<?php echo $list->kd_cermin ?>"><button class="btn btn-xs btn-flat btn-primary" data-toggle="tooltip" data-placement="top" title="Pindah Ruas Jalan"><i class="fa fa-exchange"></i></button></a>
<div id="tukar<?php echo $list->kd_cermin ?>" class="modal fade" role="dialog" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <?php echo form_open(base_url('admin/cermin/tukar/'.$list->kd_jalan.'/'.$list->kd_cermin));  ?>
         <div class="col-md-12">
            <div class="modal-body">
               <div class="row">
                  <div class="form-group col-md-12">
                     <label for="exampleInputEmail1">Kode Cermin</label>
                     <input type="text" name="kode" maxlength="30" maxlength="4" disabled class="form-control" value="<?php echo $list->kd_cermin ?>">
                  </div>
                  <div class="form-group col-md-12">
