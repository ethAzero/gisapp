...
<div class="content-wrapper">
   ...
   <div class="box box-prmary">
      <div class="box-body">
         ...
         echo form_open_multipart(base_url('admin/cermin/'));
         ?>
            <div class="col-md-10 col-lg-10 col-sm-12 col-xs-12">
               <input type="text" name="search" class="form-control" placeholder="Masukan kode cermin">
            </div>
         ...
         <table class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tbody>
               ...
               <tr class="odd gradeX">
                  ...
                  <?php $jml = $this->dashboard_model->rekapcermin($list->kd_jalan); ?>
                  ...
                  <td style="text-align:center;width:100px">
                     ...
                     <a href="<?php echo base_url('admin/cermin/detail/'.$list->kd_balai.'/'.$list->kd_jalan) ?>"><button class="btn btn-xs btn-flat btn-warning" data-toggle="tooltip" data-placement="top" title="Input Data"><i class="fa fa-map-o"></i></button></a>

                     <a href="<?php echo base_url('admin/cermin/view/'.$list->kd_balai.'/'.$list->kd_jalan) ?>"><button class="btn btn-xs btn-flat btn-primary" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></button></a>

                     <a onclick="popupCenter('<?php echo base_url('admin/cermin/cetak/'.$list->kd_jalan) ?>', 'Cetak',900,550);" href="javascript:void(0);"><button class="btn btn-xs btn-flat btn-info" data-toggle="tooltip" data-placement="top" title="Print"><i class="fa fa-print"></i></button></a>
