...
<div class="row">
   <div class="col-md-12">
      ...
      echo form_open_multipart(base_url('admin/rppj/add/'.$jalan->kd_balai.'/'.$jalan->kd_jalan), array('onsubmit' => 'return ValidasiKoordinat()'));
		?>
      <div class="row">
         <div class="col-md-9">
            <div class="box">
               <div class="box-body">
                  <div class="row">
                     ...
                     <div class="form-group col-md-2">
                        ...
                        <input type="text" name="kmlokasi" class="form-control" placeholder="Km Lokasi">
                     </div>
         ...
         <div class="col-md-3">
            <div class="box box-primary">
               <div class="modal-footer">
                  <a href="<?php echo base_url('admin/rppj/detail/'.$jalan->kd_balai.'/'.$jalan->kd_jalan) ?>"><button type="button" class="btn btn-default btn-flat"><i class="fa fa-reply"></i> Batal</button></a>
