 ...
 /* transform: 
  ...
  <body>
    <table class="table table-bordered">
          <thead>
            <tr>
              <th colspan="9" style="text-align: center;border: 0;">
            ...
            <tr>
              <th rowspan="2">No</th>
              <th rowspan="2">Kode Guardrail</th>
          ...
          <?php
          $no = 1;
          foreach ($guardrail as $row) {
          $image = ($row->img_guardrail) ? '<img src="assets/upload/guardrail/'.$row->img_guardrail.'" width="80" >': '' ;

          if($row->lat){
          ?>  
            <tr>
              <td><?php echo $no;?></td>
              <td><?php echo $row->kd_guardrail;?></td>
              <td><?php echo $row->lat;?></td>
              <td><?php echo $row->lang;?></td>
              <td><?php echo $row->panjang;?> Beam</td>
