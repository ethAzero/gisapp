...
<script>
   function myMap() {
      ...
      var ctaLayer = new google.maps.KmlLayer({
         url: '<?php echo base_url(); ?>' + 'admin/guardrail/jalanprovinsi/' + <?php echo $ruas->kd_jalan ?> + '?dummy=' + (new Date()).getTime(),
         map: map
      });
      ...
      var features = [
         <?php foreach ($view as $key => $view) : ?> {
               ...
               image: '<?php if ($view->img_guardrail != null) {
                           echo base_url('assets/upload/guardrail/thumbs/' . $view->img_guardrail);
                        } else {
                           echo base_url('assets/theme/img/map-marker-logo.jpg');
                        } ?>',
               imagezoom: '<?php if ($view->img_guardrail != null) {
                              echo base_url('assets/upload/guardrail/' . $view->img_guardrail);
                           } else {
                              echo base_url('assets/theme/img/map-marker-logo.jpg');
                           } ?>'
            },
