...
header("Content-Disposition: attachment; filename=progressdaerahrawan.xls");
header("Pragma: no-cache");
header("Content-Transfer-Encoding: BINARY");
header("Expires: 0");
?>
<div class="header">
<div class="cetak-title2">PROGRESS DAERAH RAWAN</div>
...
<table border="1" width="100%">
   <tbody>
      <tr style="font-weight:bold;">
         ...
         <td style="vertical-align:middle" height="40" align="center">Tertangani</td>
      </tr>
      <?php 
         $i=1;
