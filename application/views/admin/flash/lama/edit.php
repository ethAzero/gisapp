...
<div class="row">
   <div class="col-md-12">
      ...
      if(isset($error)){
		...
		echo form_open_multipart(base_url('admin/flash/edit/'.$flash->kd_flash), array('onsubmit' => 'return ValidasiKoordinat()'));
		?>
      <div class="row">
         <div class="col-md-9">
            <div class="box">
               <div class="box-body">
                  <div class="row">
                     ...
                     <div class="form-group col-md-5">
                        ...
                        <select name="ruas" class="form-control">
                           ...
                           <?php foreach ($jalan as $key => $jalan): ?>
                              <option value="<?php echo $jalan->kd_jalan ?>" <?php if($jalan->kd_jalan === $flash->kd_jalan) {echo "selected";} ?> ><?php echo $jalan->nm_ruas ?></option>
                           <?php endforeach ?>
                        </select>
                     </div>
                     <div class="form-group col-md-2">
                     ...
                     <div class="form-group col-md-5">
                        ...
                        <input type="text" name="letak" class="form-control" value="<?php echo $flash->letak ?>" placeholder="Letak">
                     </div>
                     <div class="form-group col-md-3">
