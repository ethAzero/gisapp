                  ...
                  <div class="row">
                     ...
                     <div class="form-group col-md-6">
                        <label for="exampleInputEmail1">Password</label><small>
                           <font color="#696969"> (Min 6 Karakter, Max 32 Karakter)</font>
                        </small>
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="akseslevel">
                           <option value="U" <?php if ($pengguna->akseslevel == 'U') {
                                                echo "selected";
                                             } ?>>User</option>
                           <option value="A" <?php if ($pengguna->akseslevel == 'A') {
                                                echo "selected";
                                             } ?>>Admin</option>
                           <option value="AD" <?php if ($pengguna->akseslevel == 'AD') {
                                                   echo "selected";
                                                } ?>>Admin Aduan</option>
                           <?php foreach ($balai as $key => $balai) : ?>
                              <option value="<?php echo $balai->kd_balai ?>" <?php if ($balai->kd_balai === $pengguna->akseslevel) {
                                                                                 echo "selected";
                                                                              } ?>><?php echo $balai->nm_balai ?></option>
                           <?php endforeach ?>
                        </select>
                     </div>
                  </div>
