...
?>
<a href="#" data-toggle="modal" data-target="#tukar<?php echo $list->kd_apil ?>"><button class="btn btn-xs btn-flat btn-primary" data-toggle="tooltip" data-placement="top" title="Pindah Ruas Jalan"><i class="fa fa-exchange"></i></button></a>
<div id="tukar<?php echo $list->kd_apil ?>" class="modal fade" role="dialog" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <?php echo form_open(base_url('admin/apil/tukar/'.$list->kd_jalan.'/'.$list->kd_apil));  ?>
         <div class="col-md-12">
            <div class="modal-body">
               <div class="row">
                  <div class="form-group col-md-12">
                     <label for="exampleInputEmail1">Kode Apill</label>
                     <input type="text" name="kode" maxlength="30" maxlength="4" disabled class="form-control" value="<?php echo $list->kd_apil ?>">
                  </div>
                  <div class="form-group col-md-12">
