 ...
 /* transform: 
  ...
  <body>
    <table class="table table-bordered">
          <thead>
            <tr>
               <th colspan="7" style="text-align: center;border: 0;">
          ...
          $image = ($row->img_marka) ? '<img src="assets/upload/marka/'.$row->img_marka.'" width="80" >': '' ;

          if($row->lat){
          ?>  
            <tr>
              <td><?php echo $no;?></td>
              <td><?php echo $row->kd_marka;?></td>
