   ...
   function myMap() {
      ...
      var features = [
         <?php foreach ($list as $key => $list) : ?> {
               id: '<?php echo $list->kd_perlintasan ?>',
               ...
               image: '<?php if ($list->img_perlintasan != null) {
               ...
               status: '<?php echo $list->status_penjagaan ?>',
               ruas_jl: '<?php echo $list->status_jalan ?>'
            },
         <?php endforeach ?>
      ];
      ...
      features.forEach(function(feature) {
         ...
         var contentString = '' +
            ...
            '<label class="isi">Status : ' + feature.status + '</label>' +
            '<label class="isi">Ruas Jl : ' + feature.ruas_jl + '</label>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '</div>' +
            '<a target="_blank" href="<?= base_url('perlintasan/details/') ?>' + feature.id + '"><button>Detail</button></a>' +
            '</div>';
