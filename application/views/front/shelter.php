      ...
      <div class="legenda">
         <div class="panel-info-legenda">
            ...
            <!-- <?php foreach ($count as $key => $count): ?>
               	...
               	<tr>
                	<td><img src="<?php echo base_url('assets/theme/img/shelter_tawang_bawen.png') ?>">Arah Purbalingga - Purwokerto : <?php echo $count->PBRPWT ?> Shelter</td>
               	</tr>
               	<tr>
                	<td><img src="<?php echo base_url('assets/theme/img/shelter_bawen_tawang.png') ?>">Arah Purwokerto - Purbalingga : <?php echo $count->PWTPBR ?> Shelter</td>
               	</tr> -->

               <!-- <tr>
                  <td><img src="<?php if($count->yes) echo base_url('assets/theme/img/shelter_bawen_tawang.png') ?>">Arah Bawen - Tawang : <?php echo $count->BT ?> Shelter</td>
               </tr> -->
            ...
            <?php foreach ($listarah as $key => $arah): 
            	
           	?>
               	<tr>
                	<td><img src="<?php if($arah->jns_shelter == 'keluar' ){echo base_url('assets/theme/img/shelter_bawen_tawang.png');}else{echo base_url('assets/theme/img/shelter_tawang_bawen.png');} ?>">Arah <?=$arah->nm_arah?> : <?php echo $this->home_model->jml_arah_shelter($arah->kd_arah); ?> Shelter</td>
               	</tr>
            ...
            <?php endforeach ?>
            	<tr>
                  <td><img src="<?php echo base_url('assets/theme/img/point.png') ?>"> <?php echo $this->home_model->jml_arah_shelter('P'); ?> Awal / Akhir </td>
               </tr>
      ...
      <?php foreach ($list as $key => $list): ?>
         {
            ...
            type: '<?php echo $list->jns_shelter ?>',
