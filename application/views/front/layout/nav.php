...
<div class="sidebar-nav navbar-collapse">
   ...
   <ul class="nav" id="side-menu">
      ...
      <!-- <li> <a href="<?php echo base_url('daerahrawankecelakaan') ?>"><i class="fa fa-exclamation-triangle"></i> Daerah Rawan Kecelakaan</a> </li> -->
      ...
      <li> <a href="javascript:void(0)" class="menudropdown"><i class="fa fa-map-signs fa-fw"></i> Perlengkapan Jalan<span class="fa arrow"></span></a>
         <ul class="nav nav-second-level">
            ...
            <li><a href="<?php echo base_url('delinator') ?>">Delinator</a></li>
