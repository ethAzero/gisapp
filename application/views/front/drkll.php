   ...
   var features = [ 
      ...
      <?php foreach ($list as $key => $list): ?>

         {
            ...
            ketdaer: '<?php echo $list->ket_daerah ?>',

            statusjln: '<?php if($list->status == 1){echo "Baik" ; } else if($list->status == 0){ echo "Tidak Baik" ; }else{ echo "Survey Gabungan" ;} ?>',
                        ...
                        '<div class="map-item-info">' +
                           ...
                           '<div class="describe">' +
                              ...
                              '<div class="grup-info">' +
                                 ...
                                 '<label class="isi">' + feature.statusjln + '</label>' +

                                 '<label class="title">Deskirpsi</label>' +

                                 '<label class="isi">' + feature.ketdaer + '</label>' +
